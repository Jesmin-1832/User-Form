...
function Useform() {
    ...
    return (
        <div>
                    ...
                    <center>
                        <form method="post" onSubmit={(e) => submitdata(e)}>
                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td colSpan={3}>
                                            <select name="security_que" onChange={(e) => getInputvalue(e)} value={person.security_que ? person.security_que : ""}>
                                                <option value="" key="">--Security Question--</option>
                                ...
                                <table border={1} style={{ marginBottom: "30px",width:"60%" }}>
                                    <tr>
            ...
            <h2 style={{textAlign:"center"}}>View Data</h2>
            <div className="bg" style={{ display: "flex",justifyContent:"center", flexWrap:"wrap",backgroundColor: "white",marginBottom:"100px" }}>
                {userData.map((v, i) => {
                    return (
                        <div key={i} className="bg">
                            <center className="container">
                                ...
                                <button onClick={() => deleterecord(i)} style={{ padding: "10px 20px", marginTop: "30px" }}>Delete</button>
                            </center>
                        </div>
                    );
                })}
